...
export default function NavMenu({ toggle, setToggle }: NavMenuProps) {
    ...
    return (
        <div className="flex items-center gap-4 sm:gap-6">
            ...
            <button
                className="relative hdr_wishList_btn"
            ...
            <div
                className={`wishlist_popup w-80 md:w-96 absolute z-50 top-full right-0 sm:right-20 xl:right-11 bg-white dark:bg-title py-5 md:py-[30px] pl-5 md:pl-[30px] pr-[10px] md:pr-[15px] border border-primary ${
                    wishList ? 'block' : 'hidden'
                }`}
            >
                <h4 className="font-medium leading-none dark:text-white mb-4 text-xl md:text-2xl">
                    Wishlist
                </h4>
                <div>
            ...
            <button
                className="relative hdr_cart_btn"
            ...
            <div
                className={`hdr_cart_popup w-80 md:w-96 absolute z-50 top-full right-0 sm:right-10 xl:right-0 bg-white dark:bg-title p-5 md:p-[30px] border border-primary ${
                    cart ? '' : 'hidden'
                }`}
            >
                ...
                <div>
                    <div className="hdr-cart-item">
                        {cartList.map((item, index) => {
                            return (
                                <div
                                    className="flex gap-[15px] relative pb-[15px] mb-[15px] border-b border-bdr-clr dark:border-bdr-clr-drk group"
                                    key={index}
                                >
                                    <Link
                                        to="/product-details"
                                    ...
                                    >
                                        <img
                                            className="w-[70px] md:w-auto h-full"
                                            src={item.image}
                                            alt="cart"
                                        />
                                    </Link>
                    ...
                    <div className="pt-5 md:pt-[30px] mt-5 md:mt-[30px] border-t border-bdr-clr dark:border-bdr-clr-drk">
                        <h4 className="mb-5 md:mb-[30px] font-medium !leading-none text-lg md:text-xl text-right">
                            Subtotal : $870
                        </h4>
                            ...
                            <div className="mt-10 md:mt-12">
                                ...
                                <div className="flex flex-wrap gap-[10px] md:gap-[15px] mt-5 md:mt-6">
                                    {blogTag.map((item, index) => {
                                        return (
                                            <Link
                                                className="btn btn-theme-outline btn-xs"
                                                to="#"
                                                data-text={item}
                                                key={index}
                                            >
