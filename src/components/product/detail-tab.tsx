    ...
    return (
        <div className="max-w-[985px] mx-auto">
            <div className="product-dtls-navtab  border-y border-bdr-clr dark:border-bdr-clr-drk">
                ...
                >
                    <li
                        className={`py-3 sm:py-5 lg:6 relative before:absolute before:w-full before:h-[1px] before:bg-title before:top-full before:left-0 before:duration-300 dark:before:bg-white before:opacity-0 ${
                            activeTab === 1 ? 'active' : ''
                        }`}
                    >
                        <Link
                ...
                {activeTab === 1 && (
                    <div>
                        <p className="sm:text-lg">
                            Experience the epitome of grace with our Classic
                            Handwoven Saree. Crafted from premium fabric and
                            adorned with intricate detailing, it offers
                            unmatched elegance for any occasion — be it a
                            festive celebration or an intimate gathering. Its
                            timeless design blends tradition with modern
                            sophistication, while the rich craftsmanship ensures
                            it remains a cherished piece in your wardrobe for
                            years to come.
                        </p>
                        <ul className="mt-4 sm:mt-6 grid gap-4 sm:gap-5 sm:text-lg leading-none">
                            <li>Leather : From India</li>
                            <li>Brand : Navana</li>
                        </ul>
                    </div>
                )}
                        ...
                        <div className="max-w-[905px] flex items-start xl:justify-between gap-8 flex-wrap">
                            {detailReview.map((item, index) => {
                                return (
                                    ...
                                    >
                                        <svg
                                            className="fill-current text-[#E8E9EA] dark:text-white-light"
                                            width="60"
                                            height="51"
                                            viewBox="0 0 60 51"
                                            fill="none"
                                        ...
                                        <h6 className="font-semibold leading-none mt-[10px]">
                                            {item.name}
                                        </h6>
