                ...
                <div className="w-full md:w-1/2 lg:max-w-lg xl:max-w-3xl lg:w-full py-16 px-[20px] sm:px-8 lg:p-16 xl:p-24 relative z-10 flex items-center overflow-hidden">
                    <div className="mx-auto md:mx-0 max-w-md">
                        ...
                        >
                            ...
                            <input
                                className="w-full h-12 md:h-14 bg-white dark:bg-transparent border border-bdr-clr focus:border-primary p-4 outline-none duration-300 placeholder:text-xl placeholder:transform placeholder:translate-y-[10px]"
                                type="password"
                                placeholder="* * * * * * * *"
                            />
                        </div>
                        ...
                        >
                            <label className="flex items-center gap-2 iam-agree">
                                ...
                                <span className="w-[18px] h-[18px] rounded-[5px] border-2 border-title dark:border-white flex items-center justify-center duration-300">
                                    <svg
                                        className="duration-300 opacity-0 fill-current text-title dark:text-white"
                                        width="9"
                                        height="8"
                                        viewBox="0 0 9 8"
                                        fill="none"
                        ...
                        <div data-aos="fade-up" data-aos-delay="600">
                            <Link
                                to="#"
                                className="btn btn-theme-solid mt-[15px]"
                                data-text="Login"
                            >
                                <span>Login</span>
                            </Link>
                        ...
                        >
                            ...
                            <Link
                                to="/register"
                                className="text-primary font-medium ml-1 inline-block"
                            >
                                Register
                            </Link>
                        </p>
