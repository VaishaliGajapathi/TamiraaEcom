        ...
        <>
            ...
            <div className="pt-36 sm:pt-52 lg:pt-[250px] pb-12 sm:pb-16 lg:pb-36 2xl:py-[360px] bg-[#f5f5f5] dark:bg-dark-secondary relative z-[1] overflow-hidden">
                <div className="absolute -z-[1] top-0 left-0 w-[60%] 2xl:w-[955px]">
                    <svg
                        className="fill-current text-[#BB976D] dark:text-title w-[100%]"
                        viewBox="0 0 955 780"
                        fill="none"
                ...
                <div className="container">
                    <div className="max-w-1366 mx-auto flex flex-col gap-10">
                        <div>
                            <h4 className="leading-none font-medium dark:text-white">
                                All products in Store
                            </h4>
                            <h2 className="leading-none text-4xl sm:text-5xl xl:text-6xl 2xl:text-7xl font-bold mt-6 dark:text-white">
                                Get <span className="text-primary">25%</span>{' '}
                                Off
                            </h2>
                            <p className="mt-4 md:mt-5 dark:text-white-light md:max-w-[350px] lg:max-w-xl">
                                Unlock unbeatable savings on every purchase.
                                Introducing our new collection of stylish and
                                comfortable sofas, designed to elevate your
                                living space with modern elegance.{' '}
                            </p>
                ...
                <Link
                    to=""
                    className="w-7 lg:w-9 h-12 lg:h-[60px] rounded-[69px] border-[1.5px] border-title dark:border-white text-title dark:text-white flex items-center justify-center absolute bottom-7 md:bottom-12 left-1/2 transform -translate-x-1/2"
                    id="scroll-button"
                >
            ...
            <div className="s-py-100-50" id="sec-2">
                <div className="container">
                    <div className="max-w-[1365px] mx-auto flex 2xl:items-center gap-[30px] md:gap-10 justify-between flex-col 2xl:flex-row">
                        <div
                            className="2xl:max-w-[360px] w-full flex justify-between 2xl:justify-start flex-wrap items-end 2xl:items-start gap-5 2xl:gap-0 flex-row 2xl:flex-col"
                            data-aos="fade-up"
                        >
                            <div>
                                <img src={chair} alt="" className="size-16" />
                                <h2 className="mt-[15px] leading-none">
                                    Popular Collection
                                </h2>
                                <p className="mt-[10px] md:mt-[15px]">
                                    Explore our curated popular collection
                                    product categories featuring high-quality
                                    furniture.{' '}
                                </p>
                            </div>
                            <Link
                                className="btn btn-outline 2xl:mt-6"
                                to="/shop-v2"
                                data-text="See all Productss"
                            >
                                <span>See all Productss</span>
                            </Link>
                        </div>
                        <div
                            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-6 lg::gap-8 2xl:max-w-[903px] w-full"
                            data-aos="fade-up"
                            data-aos-delay="300"
                        >
                                    ...
                                    <div className="group" key={index}>
                                        <div className="relative overflow-hidden">
                                            ...
                                            <div className="absolute z-10 top-1/2 left-1/2 transform -translate-y-2/4 -translate-x-2/4 flex gap-2">
                                                ...
                                                <Link
                                                    to="/cart"
                                                    className="w-9 lg:w-12 h-9 p-2 lg:h-12 bg-white dark:bg-title bg-opacity-80 flex items-center justify-center transform translate-y-8 opacity-0 transition-all group-hover:duration-500 group-hover:opacity-100 group-hover:translate-y-0 relative tooltip-icon rounded-full"
                                                >
            ...
            <div
                className="s-py-50 overflow-hidden"
                data-aos="fade-up"
                data-aos-delay="300"
            >
                <OwlCarousel
                    {...options}
                    className="owl-carousel blog-v1-wrapper"
                >
                            ...
                            >
                                ...
                                <div className="absolute bottom-7 left-0 px-5 transform w-full flex justify-center">
                                    <div className="min-w-[250px] bg-white bg-opacity-80 dark:bg-title dark:bg-opacity-80 p-5 z-10">
                                        <h4 className="leading-[1.5] font-semibold">
                                            {item.name}
                                        </h4>
            ...
            <div className="s-py-50-100">
                <div className="container max-w-[1365px] mx-auto">
                    ...
                    >
                        ...
                        <p className="mt-[10px] md:mt-[15px]">
                            Discover the latest must-have arrivals! Elevate your
                            style with our newest collection of trendsetting
                            items.{' '}
                        </p>
                    </div>
                    <div
                        ...
                        <div className="grid gap-[30px]">
                            <div className="grid sm:grid-cols-2 gap-[30px]">
                                {productList.slice(2, 4).map((item, index) => {
                                    return (
                                        <div
                                            className="group group flex flex-col"
                                            key={index}
                                        >
                                            <div className="relative overflow-hidden">
                                                <img
            ...
            <div
                className="bg-primary-light px-5 py-7 md:py-12 dark:bg-primary dark:bg-opacity-20"
                data-aos="fade-up"
                data-aos-delay="100"
            >
                <div className="container">
