        ...
        <>
                ...
                <div className="relative">
                    <div>
                        <button
                            ...
                            className="absolute top-1/2 transform -translate-y-1/2 left-0 z-10 shop_prev w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-white duration-300 bg-title bg-opacity-90 hover:bg-primary p-2"
                        >
                            <svg
                        ...
                        <button
                            ...
                            className="absolute top-1/2 transform -translate-y-1/2 z-10 right-0 shop_next w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-white duration-300 bg-title bg-opacity-90 hover:bg-primary p-2"
                        >
                            <svg
                                className="fill-current"
                                width="24"
                    ...
                    >
                        <OwlCarousel
                            {...option}
                            ref={carouselRef}
                            className="owl-carousel shop-v3-slider max-w-[1440px] mx-auto"
                        >
                            {productSlider.map((item, index) => {
                                return (
                                    <Link
                                        to="/product-category"
                                        className="relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-title before:bg-opacity-70 group before:opacity-0 before:duration-300 hover:before:opacity-100 overflow-hidden before:z-10 block"
                                        key={index}
                                    >
                                        <img
                                            className="w-full object-cover transform duration-300 group-hover:scale-110"
                                            src={item.image}
                                            alt="shop"
                                        />
                                        <div className="absolute z-20 w-full h-full flex top-0 left-0 flex-col items-center justify-center px-5">
                                            <h3 className="text-white leading-tight font-semibold transform -translate-y-5 opacity-0 duration-300 group-hover:-translate-y-0 group-hover:opacity-100">
                                                {item.name}
                                            </h3>
                                            <span className="text-white leading-none divide-black mt-3 transform translate-y-5 opacity-0 duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                                                {item.product}
                                            </span>
                                        </div>
                                    </Link>
            ...
            <div className="s-py-50-100">
                <div className="container-fluid">
                    <div
                        className="flex items-center lg:justify-center gap-6 flex-wrap"
                        data-aos="fade-up"
                        data-aos-delay="100"
                    >
                        <div className="flex items-start sm:items-center gap-[15px] flex-wrap sm:flex-nowrap sm:max-w-[420px] w-full flex-col sm:flex-row">
                            <h4 className="font-medium leading-none text-xl flex-none">
                                Choose Brand
                            </h4>
                        ...
                        <div className="sm:max-w-[411px] w-full flex items-start sm:items-center gap-[15px] flex-wrap sm:flex-nowrap flex-col sm:flex-row">
                            ...
                            <div className="grid grid-cols-2 gap-[15px] sm:max-w-[260px] w-full">
                                <div className="py-[10px] px-5 border border-title dark:border-white-light flex items-center justify-center gap-[5px]">
                                    <span className="text-title dark:text-white font-medium leading-none">
                                        Min:
                                    </span>
                                    <div className="relative">
                                        <span className="text-title dark:text-white font-medium leading-none absolute left-0 top-1/2 block transform -translate-y-1/2">
                                            $
                                        </span>
                                        <input
                                            className="pl-[10px] w-full appearance-none bg-transparent text-title dark:text-white font-medium leading-none placeholder:text-title dark:placeholder:text-white placeholder  placeholder:font-medium placeholder:leading-none outline-none "
                                            type="number"
                                            placeholder="0"
                                            value="0"
                                        />
                                ...
                                <div className="py-[10] px-5 border border-title dark:border-white-light flex items-center justify-center gap-[5px]">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            className="pl-[10px] w-full appearance-none bg-transparent text-title dark:text-white font-medium leading-none placeholder:text-title dark:placeholder:text-white  placeholder:font-medium placeholder:leading-none outline-none "
                                            type="number"
                                            placeholder="100"
                                            value="100"
                                        />
                    ...
                    <div
                        className="max-w-[1720px] mx-auto mt-8 md:mt-12"
                        data-aos="fade-up"
                        data-aos-delay="300"
                    >
                    ...
                    <div
                        className="text-center mt-7 md:mt-12"
                        data-aos="fade-up"
                    >
                        <Link
                            to="/shop-v1"
