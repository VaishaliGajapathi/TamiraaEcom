    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/index-v4" element={<Index />} />
                ...
                <Route
                    path="/portfolio-details-v1"
                    element={<PortfolioDetailsV1 />}
                />
                <Route
                    path="/portfolio-details-v1/:id"
                    element={<PortfolioDetailsV1 />}
                />
                <Route
                    path="/portfolio-details-v2"
                    element={<PortfolioDetailsV2 />}
                />
                <Route
                    path="/portfolio-details-v2/:id"
                    element={<PortfolioDetailsV2 />}
                />
                ...
                <Route
                    path="/blog-details-v1/:id"
                    element={<BlogDetailsV1 />}
                />
                <Route path="/blog-details-v2" element={<BlogDetailsV2 />} />
                <Route
                    path="/blog-details-v2/:id"
                    element={<BlogDetailsV2 />}
                />
